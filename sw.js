const CACHE = 'ascendry-alpha-v0.2.0';
const ASSETS = [
  './', './index.html?v=0.2.0', './css/styles.css?v=0.2.0', './css/alpha.css?v=0.2.0', './css/alpha-workout.css?v=0.1.3', './css/alpha-game.css?v=0.2.0',
  './js/data.js?v=0.2.0', './js/storage.js?v=0.2.0', './js/combat.js?v=0.2.0', './js/alpha-exercises.js?v=0.1.3',
  './js/alpha-onboarding-tools.js?v=0.1.3', './js/alpha-generator.js?v=0.1.3', './js/alpha-workout-core.js?v=0.1.3',
  './js/alpha-runner.js?v=0.1.3', './js/alpha-upgrade.js?v=0.2.0', './js/alpha.js?v=0.2.0', './js/alpha-game-data.js?v=0.2.0',
  './js/alpha-game-engine.js?v=0.2.0', './js/alpha-game-ui.js?v=0.2.0', './js/app.js',
  './manifest.webmanifest?v=0.2.0', './assets/icons/icon-192.png', './assets/icons/icon-512.png',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(
    caches.match(event.request).then(cached => cached || fetch(event.request).then(response => {
      ...
      return response;
    }).catch(() => caches.match('./index.html?v=0.2.0') || caches.match('./index.html')))
  );
});
