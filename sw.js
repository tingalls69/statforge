// Ascendry public alpha cache manifest — UI cycle 0.4.2
...
const ASSETS = [
  ...
  `./css/styles.css${v}`, `./css/alpha.css${v}`, `./css/alpha-game.css${v}`, `./css/alpha-public-polish.css${v}`, `./css/alpha-workout.css${v}`, `./css/alpha-workout-fantasy.css${v}`,
